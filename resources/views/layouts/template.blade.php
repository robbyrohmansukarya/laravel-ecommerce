...
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="../../index2.html" class="navbar-brand"><b>Toko Baju</b></a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
            ...
            <li class="nav nav-item dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="navbarDropdown">Product <span class="caret"></span></a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item fa fa-reorder" href="{{ route('admin.products.index')
                        }}">List</a>
                            <br>
                    <a class="dropdown-item fa fa-plus-square" href="{{ route('admin.products.create')
                        }}">Tambah</a>
                </div>
            </li>
          ...
          <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle 	fa fa-credit-card" aria-hidden="true" href="#" id="navbarDropdown"
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item fa fa-hand-o-right" aria-hidden="true" href="{{ route('logout') }}"
  ...
  <footer class="main-footer">
    <div class="container">
      ...
      <strong>Copyright &copy; 2019 <a href="https://adminlte.io">RRS</a>.</strong> All rights
      reserved.
    </div>
    <!-- /.container -->
  </footer>
